...
<head>
<meta charset="utf-8">
<title>Sosa | <?php echo $title;?></title>
        ...
        <div class="navbar navbar-default navbar-static-top" >
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Sosa Attachment Management Portal<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo web_root; ?>index.php?q=search-company">Attachment By Company</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-function">Attachment By Function</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-jobtitle">Attachment By Title</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Sosa Attachment Management Portal All right reserved.
            </p>
          </div>
        </div>
        <div class="col-lg-6">
